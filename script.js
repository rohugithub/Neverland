...
function split3(){
  var clutter3=""
  document.querySelector("#page2-part2>h1").textContent.split("").forEach(function(char){
      clutter3 += `<span>${char}</span>`

  });
  document.querySelector("#page2-part2>h1").innerHTML=clutter3;

}

split3();

// text reover left to right
gsap.to("#page2-part2>h1>span",{
  scrollTrigger:{
    trigger:'#page2-part2>h1>span',
    scroller:'#main',
...
function split4(){
  var clutter4=""
  document.querySelector("#page2-part2>h2").textContent.split("").forEach(function(char){
      clutter4 += `<span>${char}</span>`

  });
  document.querySelector("#page2-part2>h2").innerHTML=clutter4;

}
split4();

// text remove left to right
gsap.to("#page2-part2>h2>span",{
  scrollTrigger:{
...
// split the text page3-h4

function split5(){
  var clutter5=""
  document.querySelector("#page3>h4").textContent.split("").forEach(function(char){
      clutter5 += `<span>${char}</span>`

  });
  document.querySelector("#page3>h4").innerHTML=clutter5;
...
//split thee text page3-h1

function split6(){
  var clutter6=""
  document.querySelector("#page3>h1").textContent.split("").forEach(function(char){
      clutter6+= `<span>${char}</span>`

  });
  document.querySelector("#page3>h1").innerHTML=clutter6;
...
//split thee text page3-h3

function split7(){
  var clutter7=""
  document.querySelector("#page3>h3").textContent.split("").forEach(function(char){
      clutter7+= `<span>${char}</span>`

  });
  document.querySelector("#page3>h3").innerHTML=clutter7;
